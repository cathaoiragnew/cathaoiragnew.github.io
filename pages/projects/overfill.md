...
This project covered the entire process of developing a computer vision solution, including data curation, data cleaning, model development, and deployment on Azure Machine Learning. The video below gives a brief overview of the product.
